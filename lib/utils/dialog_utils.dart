...
class DialogUtils {
  ...
  static const String downloadDefault = 'Download our app to access all the photos, manage events, reservations, purchase tickets and get notified with instant guest list approvals and more! 🎉📲';
  static const String downloadOrganizer = '🥳 Manage your events! Download our app to access all your event company services, scanning tickets and get notified of guest list requests and more! 🎉📲';
  static const String downloadTixGuestList = '🎫 Tickets and Guest Lists! Download our app to access all the exclusive event tickets and guest lists, and get notified with approvals, updates and more! 🎉📲';
  static const String downloadPhotos = '📸 Click, Share, and Party On! Download our app to access all the photos, share them to socials, and get notified about friends getting tagged and more! 🎉📲';

  static showDownloadAppDialog(BuildContext context, String message) {
    showDialog(
        context: context,
