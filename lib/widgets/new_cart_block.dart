...
class NewCartBlock extends StatelessWidget {
  CartItem cartItem;
  BlocDao dao;
  ...
  // NewCartBlock(this.id, this.title, this.price, this.quantity, this.productId);

  NewCartBlock({required this.cartItem, required this.dao});
