...
class ConfirmTixTierItem extends StatefulWidget {
  ...
  ConfirmTixTierItem({Key? key, required this.tixTier, required this.isUser})
      : super(key: key);
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: ListTile(
                title: Row(
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                        text:
                            '${widget.tixTier.tixTierName} ${widget.isUser ? 'x ${widget.tixTier.tixTierCount}' : ''} ',
                              ...
                              onPressed: () {
                                setState(() {
                                  if (widget.tixTier.guestsRemaining > 0) {
                                    int guestsRemaining =
                                        --widget.tixTier.guestsRemaining;
                                    widget.tixTier = widget.tixTier.copyWith(
                    ...
                    widget.isUser
                        ...
                        : Ink(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                setState(() {
                                  if (widget.tixTier.guestsRemaining <
                                      widget.tixTier.tixTierCount) {
                                    int guestsRemaining =
                                        ++widget.tixTier.guestsRemaining;
                                    widget.tixTier = widget.tixTier.copyWith(
                                        guestsRemaining: guestsRemaining);
                ...
                trailing: Text(
                  '${StringUtils.rs} ${widget.tixTier.tixTierTotal.toStringAsFixed(2)}',
                  style: const TextStyle(
                    fontSize: 15,
                      fontWeight: FontWeight.bold),
                ),
